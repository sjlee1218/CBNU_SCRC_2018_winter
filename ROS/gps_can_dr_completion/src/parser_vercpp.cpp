	 ...
	 * char ceSerial::ReadChar(bool& success)
{
    ...
    /* after experiment with gps sensor, use this code depending on result
    else{ // this code is added by me
        mValid=0;
    }
    */
}
...
void ublox_parser::set_valid_to_fail(){
    mValid=ublox_parser::PARSING_FAIL_;
}
