...
#ifndef SERIAL_UBUNTU_PVT_PARSER_H
#define SERIAL_UBUNTU_PVT_PARSER_H
...
public :
    bool parse(ce::ceSerial com, ublox_parser::PARSING_TYPEDEF_UBX_M8P_PVT* PVT_struct);
    //void run();
    //void start();
...
#endif //SERIAL_UBUNTU_PVT_PARSER_H
